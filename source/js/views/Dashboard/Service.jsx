        ...
        <ul className='service__description'>
          ...
          {detailed ? (
            <div className='service__details'>
              <li className='service__description__value'>Variables: { variables }</li>
              <li className='service__description__value'>Ports: { ports }</li>
              <li className='service__description__value'>Volumes: { volumes }</li>
            </div>
          ) : (null)}
        </ul>
        <button
